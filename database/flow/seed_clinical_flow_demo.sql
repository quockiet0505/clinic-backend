...
BEGIN
    ...
    DELETE mr FROM medical_record mr JOIN appointment ap ON mr.appointment_id = ap.appointment_id JOIN patient p ON ap.patient_id = p.patient_id JOIN account a ON p.account_id = a.account_id WHERE a.email IN ('bn1@gmail.com', 'bn2@gmail.com', 'bn3@gmail.com', 'bn4@gmail.com', 'bn5@gmail.com', 'bn6@gmail.com', 'bn7@gmail.com', 'bn8@gmail.com');
    DELETE ap FROM appointment ap JOIN patient p ON ap.patient_id = p.patient_id JOIN account a ON p.account_id = a.account_id WHERE a.email IN ('bn1@gmail.com', 'bn2@gmail.com', 'bn3@gmail.com', 'bn4@gmail.com', 'bn5@gmail.com', 'bn6@gmail.com', 'bn7@gmail.com', 'bn8@gmail.com');
    DELETE p FROM patient p JOIN account a ON p.account_id = a.account_id WHERE a.email IN ('bn1@gmail.com', 'bn2@gmail.com', 'bn3@gmail.com', 'bn4@gmail.com', 'bn5@gmail.com', 'bn6@gmail.com', 'bn7@gmail.com', 'bn8@gmail.com');
    ...
    DELETE ar FROM account_role ar JOIN account a ON ar.account_id = a.account_id WHERE a.email IN ('bn1@gmail.com', 'bn2@gmail.com', 'bn3@gmail.com', 'bn4@gmail.com', 'bn5@gmail.com', 'bn6@gmail.com', 'bn7@gmail.com', 'bn8@gmail.com', 'bacsi@gmail.com', 'lab@gmail.com', 'letan@gmail.com');
    DELETE FROM account WHERE email IN ('bn1@gmail.com', 'bn2@gmail.com', 'bn3@gmail.com', 'bn4@gmail.com', 'bn5@gmail.com', 'bn6@gmail.com', 'bn7@gmail.com', 'bn8@gmail.com', 'bacsi@gmail.com', 'lab@gmail.com', 'letan@gmail.com');
    ...
    SET v_today = CURDATE();
        ...
        VALUES (@pat, v_doc_staff, v_expertise, DATE_ADD(v_today, INTERVAL 1 DAY), '11:00:00', '11:30:00',
            'WALK_IN', 'PENDING', 'STAFF', 'DOCTOR', 0);
        SET @apt = LAST_INSERT_ID();
        INSERT INTO medical_record (patient_id, appointment_id, main_doctor_id, diagnosis, treatment, note, status, vitals_taken)
        ...
        INSERT INTO appointment (patient_id, main_doctor_id, expertise_id, appointment_date, time_start, time_end,
            appointment_type, status, created_by, booking_mode, is_deleted)
        VALUES (@pat, v_doc_staff, v_expertise, DATE_ADD(v_today, INTERVAL 2 DAY), '14:00:00', '14:30:00',
            'ONLINE', 'CONFIRMED', 'PATIENT', 'DOCTOR', 0);
        SET @apt = LAST_INSERT_ID();
        INSERT INTO medical_record (patient_id, appointment_id, main_doctor_id, diagnosis, treatment, note, status, vitals_taken)
        ...
        -- BN8 — Đặt Dịch Vụ Online (SERVICE mode) - chờ Check-in
        INSERT INTO account (email, password, is_active) VALUES ('bn8@gmail.com', v_pwd, 1);
        SET @acc = LAST_INSERT_ID();
        INSERT INTO account_role VALUES (@acc, v_role_patient);
        INSERT INTO patient (account_id, full_name, gender, date_of_birth, phone, address, is_deleted)
        VALUES (@acc, 'BN8 - Đặt dịch vụ', 'Nữ', '1995-05-20', '0901000008', 'TP.HCM - Demo', 0);
        SET @pat = LAST_INSERT_ID();
        INSERT INTO appointment (patient_id, service_id, appointment_date, time_start, time_end,
            appointment_type, status, created_by, booking_mode, is_deleted)
        VALUES (@pat, v_lab_service, v_today, '15:00:00', '15:30:00',
            'ONLINE', 'PENDING', 'PATIENT', 'SERVICE', 0);
        SET @apt = LAST_INSERT_ID();
        INSERT INTO notification (account_id, type, content, sent_at)
        VALUES (@acc, 'SYSTEM', 'Bạn đã đặt lịch Dịch vụ thành công. Vui lòng tới phòng khám check-in đúng giờ.', NOW());

        SELECT 'SUCCESS: Demo data seeded correctly' AS result;   SELECT email, '12345678' AS password_hint FROM account
        WHERE email IN ('bacsi@gmail.com','letan@gmail.com','lab@gmail.com',
            'bn1@gmail.com','bn2@gmail.com','bn3@gmail.com','bn4@gmail.com',
            'bn5@gmail.com','bn6@gmail.com','bn7@gmail.com','bn8@gmail.com')
        ORDER BY email;
    END //
