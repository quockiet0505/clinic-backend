...
> **Chi tiết đa nền tảng:** [`appointment_booking_flows.md`](appointment_booking_flows.md)  
> **Phân tích sâu 6 luồng + edge case (slot 30p vs CLS, BS rảnh khi BN đi Lab):** [`clinical_flows_analysis.md`](clinical_flows_analysis.md)  
> **Tài liệu gốc:** [`../flow.docx`](../flow.docx)
