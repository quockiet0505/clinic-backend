...
public interface PatientMapper {
    ...
    @Mapping(source = "patient.account.isActive", target = "isActive")
    @Mapping(source = "patient.bookingLocked", target = "bookingLocked")
    @Mapping(source = "patient.cancelSpamCount", target = "cancelSpamCount")
    @Mapping(source = "vitalProfile.height", target = "height")
    @Mapping(source = "vitalProfile.weight", target = "weight")
    @Mapping(source = "vitalProfile.bloodPressure", target = "bloodPressure")
    @Mapping(source = "vitalProfile.pulse", target = "pulse")
